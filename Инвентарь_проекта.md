# Инвентарь проекта
_Сгенерировано: 2025-10-31 13:41:27_
...
│   ├── __init__.py (0 B)
│   ├── appdata.py (10689 B)
│   ├── google_auth.py (5385 B)
│   ├── google_calendar.py (7317 B)
│   ├── sync.py (8717 B)
│   ├── tasks.py (10140 B)
