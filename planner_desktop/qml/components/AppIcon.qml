    ...
    Canvas {
        ...
        onPaint: {
            ...
            if (n === "today" || n === "sun") {
                ...
                // Две стрелки по кругу — «повторяющаяся серия».
                poly([[6, 8.5], [16.5, 8.5]], false)
                poly([[14.2, 6.2], [16.7, 8.5], [14.2, 10.8]], false)
                poly([[18, 15.5], [7.5, 15.5]], false)
                poly([[9.8, 13.2], [7.3, 15.5], [9.8, 17.8]], false)
            } else if (n === "template") {
                // Лист с загнутым уголком и строками — «шаблон».
                poly([[6, 3.5], [14.5, 3.5], [18, 7], [18, 20.5], [6, 20.5]], true)
                poly([[14.5, 3.5], [14.5, 7], [18, 7]], false)
                line(8.5, 11, 15.5, 11)
                line(8.5, 14.2, 15.5, 14.2)
                line(8.5, 17.4, 13, 17.4)
            } else if (n === "sparkle") {
                ctx.beginPath()
                for (var k = 0; k < 8; k++) {
